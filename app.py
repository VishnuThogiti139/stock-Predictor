...
from services.data_loader import get_historical_data, get_live_price, get_stock_name
from services.stock_info import get_peers, get_price_prediction, get_recommendation
